...
export const configSchema = z.object({
  autonomy: z.object({ enabled: z.boolean().default(false), intervalSeconds: z.number().int().min(30).max(1800).default(90), maxTurnsPerHour: z.number().int().min(1).max(120).default(24), chatIntervalSeconds: z.number().int().min(15).max(600).default(25), playfulRefusals: z.boolean().default(true), refusalChance: z.number().min(0).max(0.5).default(0.18), refusalCooldownSeconds: z.number().int().min(60).max(3600).default(600) }).strict().prefault({}),
